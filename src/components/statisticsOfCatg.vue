    ...
    <el-row class='navRow'>
      <el-col :span="20" >
        <el-breadcrumb separator-class="el-icon-arrow-right" >
          ...
          <el-breadcrumb-item>{{this.$route.query.row.name}}套餐详情列表</el-breadcrumb-item>
        </el-breadcrumb>
      </el-col>
...
export default {
  ...
  data () {
   ...
   methods: {
    searchList(){ //搜索按钮
      this.$http.get(this.baseUrl.address+'back/user/statistics/selectCategoryByCityCode',
      {
        params: 
        {
